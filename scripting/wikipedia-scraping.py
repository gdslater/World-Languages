...
# fixing a few bugs in data set
df.drop_duplicates(subset='Country', inplace=True)
df.loc[(df.Country == 'Switzerland'),'Official language'] = "['French', 'German', 'Italian']"
# TO DO: fix bolivia languages to add indiginous?
# Is it ok to just use widely spoken and official languages?
